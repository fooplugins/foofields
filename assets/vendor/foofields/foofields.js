...
(function ($, _, _utils, _is, _obj) {
  _.Instance = _utils.EventClass.extend({
    construct: function construct() {
      ...
      self.containers = []; // bind the event listeners to ensure we have access back to this instance and can unbind the listeners later
    ...
    destroy: function destroy() {
      var self = this;
      self.trigger("destroy", [self]); // noinspection JSDeprecatedSymbols
